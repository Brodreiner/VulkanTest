...
AmrRenderPass::AmrRenderPass(AmrPhysicalDevice amrPhysicalDevice, VkDevice device, VkFormat swapChainImageFormat)
	:m_device(device)
{
	createRenderPass(swapChainImageFormat, amrPhysicalDevice);
}
