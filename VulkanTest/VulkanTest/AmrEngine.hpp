...
public:
	AmrEngine(uint32_t width, uint32_t height, const std::string& title)
		...
		, m_amrSwapChainCommandBuffers(m_amrDevice, m_amrCommandPool, m_amrPipeline, m_amrVertexBuffer, m_amrIndexBuffer, m_amrPipelineLayout, m_amrDescriptorSet, m_amrFramebufferStack)
