...
AmrVertexBuffer::AmrVertexBuffer(VkPhysicalDevice physicalDevice, VkDevice device, VkQueue queue, const AmrCommandPool& amrCommandPool, void* data, VkDeviceSize size)
{
...
AmrVertexBuffer::operator VkBuffer() const
{
	return m_buffer;
}
